...
<div class="tinv-wishlist woocommerce tinv-wishlist-clear">
    ...
    <form action="<?php echo esc_url($form_url); ?>" method="post" autocomplete="off" data-tinvwl_paged="<?php echo $wl_paged; ?>" data-tinvwl_per_page="<?php echo $wl_per_page; ?>"
        ...
        <table class="tinvwl-table-manage-list">
            <thead>
                <tr>
                    ...
                    <th class="product-cb"><input type="checkbox" class="global-cb input-checkbox" title="<?php _e('Select all for bulk action', 'ti-woocommerce-wishlist') ?>">
                    </th>
                    <?php } ?>
                    <th class="product-thumbnail">&nbsp;</th>
                    <th class="product-name"><span class="tinvwl-full"><?php esc_html_e('Tên sản phẩm', 'ti-woocommerce-wishlist'); ?></span><span
                            class="tinvwl-mobile"><?php esc_html_e('Tên sản phẩm', 'ti-woocommerce-wishlist'); ?></span>
                    </th>
                    <?php if (isset($wishlist_table_row['colm_price']) && $wishlist_table_row['colm_price']) { ?>
                    <th class="product-price"><?php esc_html_e('Đơn giá', 'ti-woocommerce-wishlist'); ?></th>
                    <?php } ?>
            ...
            <tbody>
                ...
                <tr class="<?php echo esc_attr(apply_filters('tinvwl_wishlist_item_class', 'wishlist_item', $wl_product, $product)); ?>">
                    ...
                    <td class="product-remove">
                        <button type="submit" name="tinvwl-remove" value="<?php echo esc_attr($wl_product['ID']); ?>" title="<?php _e('Remove', 'ti-woocommerce-wishlist') ?>">Xóa
                        </button>
                    </td>
                </tr>
                <?php
