...
<section class="slider-posts-auto <?php echo $fx_setting['class'] ?> ">
    <div class="slide-auto wrapper <?php echo $fx_setting['block_width']; ?>">
        ...
        <?php if (get_sub_field('arrow_display')) : ?>
            <div class="nav-slide-auto">
                <span class="slide-auto-arrow next">

                    <i class="fas fa-chevron-right"></i>
                </span>
                <span class="slide-auto-arrow prev">
        ...
        <?php if ($posts_query->have_posts()) : ?>
            <div class="content-posts-auto slide-container">
                <div class="list-posts-auto slide-list fx-layout <?php echo $column_display; ?> fx-column-gap">
