...
?>
<div class="return-shop-page-btn">
	<a class="" href="<?php echo get_permalink(wc_get_page_id('shop')); ?>">
		<h4><i class="fas fa-arrow-left"></i> &nbsp;Trang Sản Phẩm</h4>
	</a>
</div>
<div class="cart_totals <?php echo (WC()->customer->has_calculated_shipping()) ? 'calculated_shipping' : ''; ?>">
	...
	<h3><?php esc_html_e('Tổng thanh toán', 'woocommerce'); ?></h3>
